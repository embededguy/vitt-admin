<?php
  ...
  if (!isset($_SESSION["user_logged_in"]) || $_SESSION["user_logged_in"] !== true) {
    ...
    $sql = "SELECT * FROM industry_index";
...
<html lang="en">
  <head>
    ...
    <title>Vitt - All Industries</title>
    <!-- Simple bar CSS -->
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="mb-2 page-title">All Industries</h2>
              <p class="card-text">Helps, you view all Industries + Activate / Deactivate + Edit</p>
              <div class="row my-4">
                        ...
                        <tbody>
                          <?php foreach ($spec as $user) : ?>
                            <tr>
                              ...
                              <td><?php echo $user['fk_sector_id']; ?></td>
                              <td>
                              ...
                              <td>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                  <a class="dropdown-item" href="./industry_edit.php?id=<?php echo $user['id'];?>">Edit</a>
                                  <?php if($user['status'] == '1'):?>
                                    <a class="dropdown-item" href="./industry_deactivate.php?id=<?php echo $user['id'];?>">Deactivate</a>
                                  <?php else:?>
                                    <a class="dropdown-item" href="./industry_activate.php?id=<?php echo $user['id'];?>">Activate</a>
                                  <?php endif;?>
                                </div>
                              </td>
                            </tr>
