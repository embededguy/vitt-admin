                    ...
                    <form id="uploadForm" action="./controller/process_company_add.php" method="POST">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                          ...
                          <input name="symbol" type="text" class="form-control" id="inputPassword4" placeholder="Ticker Symbol">
                        </div>
                        <div class="form-group col-md-2">
                          <label for="inputPassword4">Script Code: </label>
                          <input name="script_code" type="text" class="form-control" id="inputPassword4" placeholder="Code">
                        </div>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-3">
                          ...
                          <input class="form-control" id="issuedShares" type="text" name="issued_shares" placeholder="No Of Shares Listed">
                        </div>      
                        <div class="form-group col-md-3">
                          <label for="sku">Latest Trading Price (LTP): </label>
                          <input name="ltp" type="text" class="form-control" id="ltp" placeholder="LTP">
                        </div>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-3">
                          ...
                          <input class="form-control" type="text" name="52weekhigh" placeholder="52 Week High">
                        </div>      
                        <div class="form-group col-md-3">
                          <label for="custom-money">52 Week Low Price: </label>
                          <input class="form-control" type="text" name="52weeklow" placeholder="52 Week Low">
                        </div>
                        <div class="form-group col-md-3">
                          <label for="custom-money">Previous Close: </label>
                          <input class="form-control" type="text" name="previous_close" placeholder="Previous Close">
                        </div>
                        <div class="form-group col-md-3">
                          <label for="custom-money">ROE (Return On Equity): </label>
                          <input class="form-control" type="text" name="roe" placeholder="ROE">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-3">
                          <label for="custom-money">Debt to Equity: </label>
                          <input class="form-control" type="text" name="debttoequity" placeholder="No Of Shares Listed">
                        </div>      
                        <div class="form-group col-md-3">
                          <label for="custom-money">Dividend Yield (%): </label>
                          <input class="form-control" type="text" name="d_yield" placeholder="Dividend Yield">
                        </div>
                        <div class="form-group col-md-2">
                          <label for="custom-money">Tick Size: </label>
                          <input class="form-control" type="text" name="tick_size" placeholder="Tick Size">
                        </div>
                        <div class="form-group col-md-2">
                          <label for="custom-money">Book Value: </label>
                          <input class="form-control" type="text" name="book_value" placeholder="Book Value">
                        </div>
                        <div class="form-group col-md-2">
                          <label for="custom-money">Face Value: </label>
                          <input class="form-control" type="text" name="face_value" placeholder="Face Value">
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-3">
