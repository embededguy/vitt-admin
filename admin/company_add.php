                    ...
                    <form id="uploadForm" action="./controller/process_company_add.php" method="POST">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                          ...
                          <input name="symbol" type="text" class="form-control" id="inputPassword4" placeholder="Ticker Symbol" required>
                        </div>
                        <div class="form-group col-md-2">
                          <label for="inputPassword4">Script Code: </label>
                          <input name="script_code" type="text" class="form-control" id="inputPassword4" placeholder="Code" required>
                        </div>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-3">
                          ...
                          <input class="form-control" id="issuedShares" type="text" name="issued_shares" placeholder="No Of Shares Listed" required>
                        </div>      
                        <div class="form-group col-md-3">
                          <label for="sku">Latest Trading Price (LTP): </label>
                          <input name="ltp" type="text" class="form-control" id="ltp" placeholder="LTP" required>
                        </div>
                        <div class="form-group col-md-6">
                          <label for="sku">Market Cap (Cr.): </label>
                          <input name="mcap" type="text" class="form-control" id="marketCap" placeholder="Market Cap" required>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-3">
                          <label for="custom-money">52 Week High Price: </label>
                          <input class="form-control" type="text" name="52weekhigh" placeholder="52 Week High" required>
                        </div>      
                        <div class="form-group col-md-3">
                          <label for="custom-money">52 Week Low Price: </label>
                          <input class="form-control" type="text" name="52weeklow" placeholder="52 Week Low" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="custom-money">Previous Close: </label>
                          <input class="form-control" type="text" name="previous_close" placeholder="Previous Close" required>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="custom-money">ROE (Return On Equity): </label>
                          <input class="form-control" type="text" name="roe" placeholder="ROE" required>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-3">
                          <label for="custom-money">Debt to Equity: </label>
                          <input class="form-control" type="text" name="debttoequity" placeholder="Depth to Equity" required>
                        </div>      
                        <div class="form-group col-md-3">
                          <label for="custom-money">Dividend Yield (%): </label>
                          <input class="form-control" type="text" name="d_yield" placeholder="Dividend Yield" required>
                        </div>
                        <div class="form-group col-md-2">
                          <label for="custom-money">Tick Size: </label>
                          <input class="form-control" type="text" name="tick_size" placeholder="Tick Size" required>
                        </div>
                        <div class="form-group col-md-2">
                          <label for="custom-money">Book Value: </label>
                          <input class="form-control" type="text" name="book_value" placeholder="Book Value" required>
                        </div>
                        <div class="form-group col-md-2">
                          <label for="custom-money">Face Value: </label>
                          <input class="form-control" type="text" name="face_value" placeholder="Face Value" required>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-3">
                          <label for="custom-money">Industry P/E: </label>
                          <input class="form-control" id="mrp" type="text" name="ipe" placeholder="Industry P/E" required>
                        </div>      
                        <div class="form-group col-md-3">
                          <label for="custom-money">P/E Ratio(TTM): </label>
                          <input class="form-control" id="price" type="text" name="pe" placeholder="P/E" required>
                        </div>
                        <div class="form-group col-md-2">
                          <label for="custom-money">Earning Per Share: </label>
                          <input class="form-control" id="price" type="text" name="eps" placeholder="EPS" required>
                        </div>
                        <div class="form-group col-md-2">
                          <label for="custom-money">P/B Ratio: </label>
                          <input class="form-control" id="price" type="text" name="pb" placeholder="P/B" required>
                        </div>
                        <div class="form-group col-md-2">
                          <label for="custom-money">Segment: </label>
                          <input class="form-control" type="text" name="segment" placeholder="SEG" required>
                        </div>
                      </div>
                      <br/>
