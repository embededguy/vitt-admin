<?php
  ...
  if (!isset($_SESSION["user_logged_in"]) || $_SESSION["user_logged_in"] !== true) {
    ...
    $sql = "SELECT * FROM basic_industry_index";
...
<html lang="en">
  <head>
    ...
    <title>Vitt - All Basic Industries</title>
    <!-- Simple bar CSS -->
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="mb-2 page-title">All Basic Industries</h2>
                        ...
                        <tbody>
                          <?php foreach ($spec as $user) : ?>
                            <tr>
                              ...
                              <td><?php echo $user['fk_industry_id']; ?></td>
