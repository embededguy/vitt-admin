<?php
  include('config/db.php');
      ...
      $sql="SELECT * FROM sectorial_index WHERE status = 1;";
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
            <h2 class="page-title">Add Industry</h2>
            <p class="lead text-muted">Industry: This level would indicate the industry classification of the company</p>
            <div class="row">
                <div class="col-md-12">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <strong class="card-title">ADD INDUSTRY FORM</strong>
                    </div>
                    <?php
