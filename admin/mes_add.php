      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
            <h2 class="page-title">Add Macro Economic Sector</h2>
            <p class="lead text-muted">Macro-Economic Sector Indicates business activity of a company at macro level</p>
            <div class="row">
                <div class="col-md-12">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <strong class="card-title">ADD MSE FORM</strong>
                    </div>
                    <?php
                    ...
                    ?>
                    <div class="card-body">
                      <form class="form" action="./controller/process_mes_add.php" method="POST">
                        <div class="form-row">
                          <div class="form-group col-md-3">
                            <label for="inputPassword4">M.S.E Name: </label>
                          ...
                          <div class="form-group col-md-3">
                            <label for="parentCategory">M.S.E Code: </label>
