      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
            <h2 class="page-title">Create New Blog Type</h2>
            <p class="lead text-muted">Adding New Blog type helps user to find their topic of interest easily</p>
            <div class="row">
                <div class="col-md-12">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <strong class="card-title">ADD BLOG TYPE FORM</strong>
                    </div>
                    <?php
                    ...
                    ?>
                    <div class="card-body">
                      <form class="form" action="./controller/process_blogtype_add.php" method="POST">
                        <div class="form-row">
                          <div class="form-group col-md-3">
                            <label for="inputPassword4">New Blog Type Name: </label>
                            <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>" required>               
                            <input name="name" type="text" class="form-control" id="inputPassword4" placeholder="Blog Type">
                          </div>
                        </div>
                        <br/>  
