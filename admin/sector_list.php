<?php
  ...
  if (!isset($_SESSION["user_logged_in"]) || $_SESSION["user_logged_in"] !== true) {
    ...
    $sql = "SELECT * FROM sectorial_index";
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="mb-2 page-title">All Sectors</h2>
              <p class="card-text">Helps, you view all Sectors + Activate / Deactivate + Edit</p>
              <div class="row my-4">
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                  <a class="dropdown-item" href="./sector_edit.php?id=<?php echo $user['id'];?>">Edit</a>
                                  <?php if($user['status'] == '1'):?>
                                    <a class="dropdown-item" href="./sector_deactivate.php?id=<?php echo $user['id'];?>">Deactivate</a>
                                  <?php else:?>
                                    <a class="dropdown-item" href="./sector_activate.php?id=<?php echo $user['id'];?>">Activate</a>
                                  <?php endif;?>
                                </div>
                              </td>
                            </tr>
