<?php
  ...
  if (!isset($_SESSION["user_logged_in"]) || $_SESSION["user_logged_in"] !== true) {
      ...
      $sql="SELECT * FROM mes_index WHERE status = 1;";
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
            <h2 class="page-title">Add Sector</h2>
            <p class="lead text-muted">Sector: Indicates specific sector of a company</p>
            <div class="row">
                <div class="col-md-12">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <strong class="card-title">ADD SECTOR FORM</strong>
                    </div>
                    <?php
                    ...
                    ?>
                    <div class="card-body">
                      <form class="form" action="./controller/process_sector_add.php" method="POST">
                        <div class="form-row">
                          <div class="form-group col-md-4">
                            <label for="inputPassword4">Sector Name: </label>
                            <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">               
                            <input name="name" type="text" class="form-control" id="inputPassword4" placeholder="Name" required>
                          </div>
                          <div class="form-group col-md-4">
                            <label for="inputPassword4">Sector Code: </label>
                            <input name="code" type="text" class="form-control" id="inputPassword4" placeholder="Code" required>
                          </div>
                          <div class="form-group col-md-4">
                            <label for="parentCategory">Parent M.E.S: </label>
