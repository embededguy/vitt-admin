...
<head>
    ...
    <title>Vitt App - Lumpsum Calculator</title>
    <!-- icofont-css-link -->
...
<body>
    ...
    <div class="main-container">
        <h1 class="calc-title">Home > Calculators > Lumpsum Calclator</h1>
        <br/>
        <div class="row">
            <!-- Left Column - SIP Calculator -->
            <div class="col-md-8">
                <div class="calculator-container">
        <h2 class="text-center mb-4" style="color: #06d6a0;">Lumpsum Calculator</h2>
        ...
        <div class="section">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <label for="principal-slider" class="form-label slider-label">Lumpsum Investment</label>
                    <div id="principal-slider"></div>
                    <input type="text" id="principal-input" class="input-box" value="₹100,000" hidden>
                </div>
                <div class="col-md-6">
                    <!-- Return Rate Slider -->
                    <label for="return-slider" class="form-label slider-label">Expected Return Rate (p.a.)</label>
                    <div id="return-slider"></div>
                    <input type="text" id="return-input" class="input-box" value="10%" hidden>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-md-12">
                    <!-- Time Period Slider -->
                    <label for="time-slider" class="form-label slider-label">Time Period (Years)</label>
                    <div id="time-slider"></div>
                    <input type="text" id="time-input" class="input-box" value="5 Years" hidden>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="row">
                <div class="col-md-6">
                    <canvas id="lumpsumChart" width="300" height="300"></canvas>
                </div>
                <div class="col-md-6">
                    <div class="mt-4">
        ...
        <br/>
        <div class="col-md-8">
        <h3 style="font-size: 25px;">➤ Lumpsum Calculator</h2>
        <br/>
        <p>
          A lumpsum investment is when the depositor invests a significant sum of money on a particular mutual fund scheme. SIP or Systematic Investment Plan, on the other hand, entails the investment of smaller amounts on a monthly basis.
    ...
    <script>
      ...
      function calculateLumpsum(principal, returnRate, timePeriod) {
          const futureValue = principal * Math.pow((1 + returnRate / 100), timePeriod);
      ...
      noUiSlider.create(principalSlider, {
          start: 25000,
      ...
      const lumpsumChart = new Chart(ctx, {
          type: 'doughnut',
          data: {
      ...
      // Function to update Lumpsum values and chart
      function updateLumpsum() {
          const principal = parseFormattedNumber(document.getElementById('principal-input').value);
          ...
          const { futureValue, investedAmount, returns } = calculateLumpsum(principal, returnRate, timePeriod);
          ...
          // Update chart
          lumpsumChart.data.datasets[0].data = [investedAmount, returns];
          lumpsumChart.update();
      }
      ...
      document.getElementById('principal-input').addEventListener('input', function () {
          ...
          principalSlider.noUiSlider.set(value);
      });
      ...
      principalSlider.noUiSlider.on('update', function (values) {
          document.getElementById('principal-input').value = `₹ ${formatNumberInIndianStyle(parseFloat(values[0]))}`;
          updateLumpsum();
      });
