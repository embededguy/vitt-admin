                ...
                <div class="calculator-container">                    
                    ...
                    <div class="section">
                        ...
                        <div class="progress-range-container">
                            ...
                            <div class="labels">
                                <div>
                                  <p style="margin:0 !important;">Today's Low</p>
                                  <p>0.00</p>
                                </div>
                                <div>
                                  <p style="margin:0 !important;">Today's High</p>
                                  <p>0.00</p>                                  
                                </div>
                            </div>
                        ...
                        <div class="progress-range-container">
                            ...
                            <div class="labels">
                                <div>
                                  <p style="margin:0 !important;">52 Week Low</p>
                                  <p>0.00</p>
                                </div>
                                <div>
                                  <p style="margin:0 !important;">52 Week High</p>
                                  <p>0.00</p>                                  
                                </div>
                            </div>
                            <div class="progress-bar-container">
                        ...
                        <div class="col-md-12">
                          <table class="table custom-table">
                            ...
                            <tbody>
                              <tr>
                                <td>1 Week Change</td>
                                <td id="1week"><strong>0.00%</strong></td>
                              </tr>
                              <tr>
                                <td>1 Month Change</td>
                                <td id="1month"><strong>0.00%</strong></td>
                              </tr>
                              <tr>
                                <td>3 Month Change</td>
                                <td id="3month"><strong>0.00%</strong></td>
                              </tr>
                              <tr>
                                <td>6 Month Change</td>
                                <td id="6month"><strong>0.00%</strong></td>
                              </tr>
                              <tr>
                                <td>9 Month Change</td>
                                <td id="9month"><strong>0.00%</strong></td>
                              </tr>
                              <tr>
                                <td>1 Year Change</td>
                                <td id="1year"><strong>0.00%</strong></td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", async function(event) {
      ...
      if(info){
        ...
        document.getElementById("1week").innerHTML=`<strong>${formatNumberIndian((info["data"][0]["PricePerchng1week"]).toString())} %</strong>`
        document.getElementById("1month").innerHTML=`<strong>${formatNumberIndian((info["data"][0]["PricePerchng1mon"]).toString())} %</strong>`
        document.getElementById("3month").innerHTML=`<strong>${formatNumberIndian((info["data"][0]["PricePerchng3mon"]).toString())} %</strong>`
        document.getElementById("6month").innerHTML=`<strong>${formatNumberIndian((info["data"][0]["PricePerchng6mon"]).toString())} %</strong>`
        document.getElementById("9month").innerHTML=`<strong>${formatNumberIndian((info["data"][0]["PricePerchng9mon"]).toString())} %</strong>`
        document.getElementById("1year").innerHTML=`<strong>${formatNumberIndian((info["data"][0]["PricePerchng1year"]).toString())} %</strong>`
